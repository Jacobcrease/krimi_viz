...
export interface ISmRauschgift2Props {}
...
export default class SmRauschgift2 extends React.Component<ISmRauschgift2Props> {
  public render() {
    const xAxis: number[] = [];
    const yAxis: number[] = [];
    faelleZeitreihe.items.forEach((el) => {
      if (el.Straftat !== "Rauschgiftkriminalität") {
        return;
      }
      xAxis.push(el.Jahr);
