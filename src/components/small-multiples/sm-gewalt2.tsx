...
export interface ISmGewalt2Props {}
...
export default class SmGewalt2 extends React.Component<ISmGewalt2Props> {
  public render() {
    const xAxis: number[] = [];
    const yAxis: number[] = [];
    faelleZeitreihe.items.forEach((el) => {
      if (el.Straftat !== "Gewaltkriminalität") {
        return;
      }
      xAxis.push(el.Jahr);
